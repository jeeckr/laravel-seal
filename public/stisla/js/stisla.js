  ...
  $.chatCtrl = function (element, chat) {
    ...
    var target = $(element),
      element = '<div class="chat-item ' + chat.position + '" style="display:none">' +
        ...
        '<div class="chat-name" style="fons-style:bold">' + chat.name + '</div>' +
        '<div class="chat-text">' + '<div style="font-size:15px;margin-bottom:-30px !important">' + chat.text + '</div>' + '<br>' + chat.time + '</div>' +
