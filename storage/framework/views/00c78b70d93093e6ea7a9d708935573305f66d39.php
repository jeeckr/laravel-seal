    ...
    <div class="container">
        <div class="signin-content">
            ...
            <div class="signin-form">
                ...
                <form action="<?php echo e(route('loginGuruStore')); ?>" method="POST" class="register-form" id="login-form">
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- <a href="<?php echo e(route('formRegisterGuru')); ?>" class="signup-image-link">Create an account</a> -->
            </div>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.authTemplate.AppLogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jeeckr/Documents/Laravel/Elearning/resources/views/authUser/login/loginGuru.blade.php ENDPATH**/ ?>