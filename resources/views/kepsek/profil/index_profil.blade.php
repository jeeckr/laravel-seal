                ...
                <div class="card-body">
                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                        <div class="tab-pane fade show active" id="home2" role="tabpanel" aria-labelledby="home-tab2">
                            ...
                            <div class="card">
                                <form action="{{ route('updateProfilKepsek', $kepsek->id) }}" enctype="multipart/form-data" method="post" class="needs-validation">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                <label>NIP</label>
                                                <input type="text" class="form-control" value="{{ $kepsek->nip }}" name="nip" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control codeeditor" name="alamat">{{ $kepsek->alamat }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 col-12">
                                                <label>Telepon</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control phone-number" name="telepon" value="{{ $kepsek->telepon }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <input type="text" class="form-control" name="tempat_lahir" value="{{ $kepsek->tempat_lahir }}">
                                            </div>
                                            <div class="form-group col-md-6 col-12">
                                                <label>Tanggal Lahir</label>
                                                <input type="text" class="form-control" name="tanggal_lahir" value="{{ $kepsek->tanggal_lahir }}">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" value="{{ $kepsek->email}}" disabled>
                                                </div>
                                                <div class="invalid-feedback">
